...
class WarrantyDetailsResourceIT {
    ...
    private static final Long DEFAULT_SERVICE_CONTACT = 1L;
    private static final Long UPDATED_SERVICE_CONTACT = 2L;
    ...
    void createWarrantyDetails() throws Exception {
        ...
        assertThat(testWarrantyDetails.getCoverage()).isEqualTo(DEFAULT_COVERAGE);
    ...
    void getAllWarrantyDetails() throws Exception {
        ...
        restWarrantyDetailsMockMvc
            ...
            .andExpect(jsonPath("$.[*].serviceContact").value(hasItem(DEFAULT_SERVICE_CONTACT.intValue())))
    ...
    void getWarrantyDetails() throws Exception {
        ...
        restWarrantyDetailsMockMvc
            ...
            .andExpect(jsonPath("$.serviceContact").value(DEFAULT_SERVICE_CONTACT.intValue()))
    ...
    void putExistingWarrantyDetails() throws Exception {
        ...
        assertThat(testWarrantyDetails.getCoverage()).isEqualTo(UPDATED_COVERAGE);
    ...
    void partialUpdateWarrantyDetailsWithPatch() throws Exception {
        ...
        partialUpdatedWarrantyDetails.coverage(UPDATED_COVERAGE);
